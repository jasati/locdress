(function() {
    ...
    EmpresaService.$inject = ['dataservice','DataserviseProvider','UtilsFunctions', 'config','FileUploader'];
    /* @ngInject */
    function EmpresaService(dataservice,DataserviseProvider,UtilsFunctions, config,FileUploader) {
        var campos = "e.id_empresa, e.nome, e.cpf_cnpj, e.endereco, e.responsavel, e.data_cad, e.email, e.cel, e.status, e.tel1, e.tel2, e.slogan, e.cidade, e.id_galeria, e.fantasia, e.estado, e.cad_confirm, g.imagem as logo";
        var left_join = {
